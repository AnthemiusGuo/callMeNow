...
class Progress_model extends Record_model {
    public function __construct() {
        ...
        $this->field_list['preProgressId'] = $this->load->field('Field_int',"前置进度","preProgressId");
        $this->field_list['userInCharge'] = $this->load->field('Field_string',"负责人","userInCharge");
    ...
    public function init($id){
        ...
        $this->field_list['showId']->init("1.1.1");
        $this->field_list['level']->init(3);
...
H5N1和H7N9是近年来对人类威胁最大的两种禽流感病毒，H5N1病毒自1997年在首次感染人类后，在全球60多个国家肆虐，死亡率高达60%。H7N9在2013年2月底在中国长三角地区首次出现后，也是来势汹汹，在10个月内，中国12个省市发现了148人感染，其中46人死亡。");
        ...
        $this->field_list['preProgressId']->init(1);
    ...
    public function buildInfoTitle(){
        return '进度 :'.$this->field_list['name']->gen_show_html().'<small> ID:'.$this->field_list['id']->gen_show_html().'</small>';
    }
